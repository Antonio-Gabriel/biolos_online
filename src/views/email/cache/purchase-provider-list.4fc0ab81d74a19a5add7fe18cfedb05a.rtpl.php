...
<div class="u-row-container" style="padding: 29px 10px 0px;background-color: rgba(255,255,255,0)">
  <div class="u-row" style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #24252d;">
    <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
      <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 29px 10px 0px;background-color: rgba(255,255,255,0);" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: #24252d;"><![endif]-->
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="https://lh3.googleusercontent.com/VYPdvOHEsLQ9OmGyBVzuAup7x6jKpC54USGVy0irnZg50xg4eNpjE553_J412w7I1C2wiFW8QjqEssj2LY7nBZfdijFnfQdiFLjPPfMxOKMCOfCo22S1YLBMyye-jti9BO7GLcBBRjcitLF-1tYizFUgh5Ts7WJPqkAuacSnm9Lt117DlPgIzWLvRdPaa_PxPHDqcHD-X9oc1eKibGaSmjg2fHF43F2FeHcw5MIIWjt230y1q18sFPsGF7nk3q2KQ5fLs2buIQDDF_KFnhLFa_BAz_O-tF32V7gidUdUYVx3nY289ag_BY4up2yJakpJe2MggpiTzUTN_l43DbQayct6BuZzQrI93t-VY941AoAh4GY33nFhVVU47Oe7HQwu0vjnnBP-Hc0ViOND2jOqQp8OF-oxJr9mP1Cbdk3giYfstlAwvHwLCZwI6E0z1Y7MwIqF2tqeEGDk8PHpOYMfkBHZNEBua7twqgXxDEjyheE_NP2ncIhWnuAxLcC_QJVGY0_rqf7BgzyAdPcQT16Qs6jHzagWFk8cxyzp8FCN3liz1lq6SzR76cn-R5gxcjogzhcJoLczB2Zb5SAlxT9dYU_JHgdYbFEk22ck0H2sJNB1ikdMfTjj61u2HNSf1LguSO5hIUeitEeOzLmSJaz5sokkGGq2ed3BX0UAQP3OV3Mxd6VnF52Tdb8wPd6u8JFJAsdb-gdtGO0P7EP_8JoxOXY=w809-h295-no?authuser=0" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 160px;" width="160"/>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #ffffff; line-height: 120%; text-align: right; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 120%; opacity: .7">O melhor para o seu neg&oacute;cio, reserve j&aacute; os seus produtos e fale conosco.</p>
  </div>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="line-height: 120%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 120%;"><span style="font-size: 24px; line-height: 28.8px; color: #eb1484;">Hi, <strong><?php echo DecodeToUtf8($products["0"]['fornecedor']); ?></strong></span></p>
  </div>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #757575; line-height: 160%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 14px; line-height: 22.4px;">
      ...
      <?php $counter1=-1;  if( isset($provider) && ( is_array($provider) || $provider instanceof Traversable ) && sizeof($provider) ) foreach( $provider as $key1 => $value1 ){ $counter1++; ?>
        ...
        <?php echo DecodeToUtf8($value1["fornecedor_venda"]); ?>,
      <?php } ?>
  ...
  <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 14px; line-height: 22.4px;">
    <?php $counter1=-1;  if( isset($provider) && ( is_array($provider) || $provider instanceof Traversable ) && sizeof($provider) ) foreach( $provider as $key1 => $value1 ){ $counter1++; ?>
      ...
      <?php echo DecodeToUtf8($value1["fornecedor_venda_email"]); ?>

      (<?php echo htmlspecialchars( $value1["fornecedor_venda_contacto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>),      
    <?php } ?>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #333333; line-height: 120%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 120%;"><strong><span style="font-size: 24px; line-height: 28.8px;">Tel: <?php echo htmlspecialchars( $products["0"]["fornecedor_contacto"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span></strong></p>
  </div>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #333333; line-height: 120%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 120%;"><span style="font-size: 20px; line-height: 24px;"><strong> <?php echo DecodeToUtf8($products["0"]['fornecedor_email']); ?></strong></span></p>
  </div>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #333333; line-height: 120%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 120%;"><strong><span style="font-size: 24px; line-height: 28.8px;">Produtos Reservados</span></strong></p>
  </div>
...
<p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px; color: #24252d;">De : <?php echo DecodeToUtf8($value1["fornecedor_venda"]); ?></span></p>
  </div>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #333333; line-height: 120%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 120%;"><span style="font-size: 24px; line-height: 28.8px;"><strong><span style="line-height: 28.8px; font-size: 24px;"><?php echo htmlspecialchars( $value1["total"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span> kz</strong></span></p>
  </div>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #333333; line-height: 120%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 120%;"><strong><span style="font-size: 30px; line-height: 36px;"><?php echo formatNumber($total); ?></span> kz</strong></p>
  </div>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #ffffff; line-height: 150%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 150%;"><span style="font-size: 18px; line-height: 27px;"><strong><span style="line-height: 27px; font-size: 18px;"><span style="line-height: 27px; font-size: 18px;">Obrigado po</span>r confiar em n&oacute;s!</span></strong></span></p>
<p style="font-size: 14px; line-height: 150%;">&nbsp;</p>
<p style="font-size: 14px; line-height: 150%;">&nbsp;www. biolosOnline.com</p>
<p style="font-size: 14px; line-height: 150%;">Return Policy | Shop | My Account</p>
  </div>
